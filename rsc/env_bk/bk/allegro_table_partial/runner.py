...
from raisimGymTorch.env.bin import allegro_table_partial as mano
from raisimGymTorch.env.RaisimGymVecEnvOther import RaisimGymVecEnvTest as VecEnv
from raisimGymTorch.helper.raisim_gym_helper import ConfigurationSaver, load_param, tensorboard_launcher
from raisimGymTorch.env.bin.allegro_table_partial import NormalSampler
...
for update in range(args.num_iterations):
    ...
    obs_new_r, _ = env.observe_vision_partial(contain_non_aff, allegro=True)
    ...
    for step in range(n_steps_r):
        ...
        obs_new_r, dis_info = env.observe_vision_partial(contain_non_aff, allegro=True)
    ...
    obs_r, _ = env.observe_vision_partial(contain_non_aff, allegro=True)
    # if swing_diverse:
