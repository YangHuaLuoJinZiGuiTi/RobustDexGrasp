...
class PoseTrans():
    def __init__(self):
        self.axisFK = AxisLayerFK(mano_assets_root="/home/huizhang/work/raisim/manotorch/assets/mano").to('cuda')
        self.mano_layer = ManoLayer(rot_mode="axisang",
                               center_idx=9,
                               mano_assets_root="/home/huizhang/work/raisim/manotorch/assets/mano",
                               use_pca=False,
