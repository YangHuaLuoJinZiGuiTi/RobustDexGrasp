...
def main() -> None:
    ...
    objlist = vlm.request_task("decompose_user_prompt", frame_path, command)

    for i in range(len(objlist)):
        bbox_2d = vlm.request_task("mark_bounding_box", frame_path, objlist[i])
        ...
        image.show()
        image.save("/home/ubuntu/hand/github/vision_dex/raisimGymTorch/raisimGymTorch/env/hardware/test/vlm_planning/"+str(i)+".png")
