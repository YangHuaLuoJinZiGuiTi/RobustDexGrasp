...
from raisimGymTorch.env.hardware.BundleTrack.object_tracking_online import obj_track

from ruamel.yaml import YAML, dump, RoundTripDumper
from raisimGymTorch.env.bin import conveyor_belt as mano
from raisimGymTorch.env.RaisimGymVecEnvOther import RaisimGymVecEnvTest as VecEnv
from raisimGymTorch.helper.raisim_gym_helper import ConfigurationSaver, load_param, tensorboard_launcher
from raisimGymTorch.env.bin.conveyor_belt import NormalSampler
...
def main():
    ...
    while True:
        ...
        for sim_flag in [False]: # True, False
            ...
            #csvfile = open(f"/home/ubuntu/hand/github/vision_dex/raisimGymTorch/raisimGymTorch/env/hardware/log_data/csv/reconallegro.csv","w")
