...
cross_reward = np.zeros((num_envs, 1))
...
for update in range(args.num_iterations):
    ...
    for i in range(len(rewards_r_sum)):
        ...
        rewards_r_sum[i]['cross_reward'] = 0
    ...
    for step in range(n_steps_r):
        ...
        for i in range(num_envs):
            ...
            rewards_r[i]['cross_reward'] = cross_reward[i] * cfg['environment']['reward']['cross_reward']['coeff']
            ...
            rewards_r[i]['reward_sum'] = (
                        ...
                        rewards_r[i]['table_reward'] + rewards_r[i]['arm_height_reward'] + rewards_r[i]['cross_reward'])
