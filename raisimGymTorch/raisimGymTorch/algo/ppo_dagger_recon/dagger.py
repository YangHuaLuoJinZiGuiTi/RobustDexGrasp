...
class DaggerAgent:
    def __init__(self, expert_policy,
        ...
        #         param.requires_grad = update_mlp
    ...
    #     # ly NO dagger
    #     output = torch.cat([obs[:, hlen: hlen + self.tobeEncode_dim], prop_latent, obs[:, hlen + self.tobeEncode_dim + prop_latent.shape[1]:]], 1)
