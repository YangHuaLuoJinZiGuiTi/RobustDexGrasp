...
class PoseTrans():
    def __init__(self, side_flag: str = "right"):
        print("-------------------side flag = " + side_flag)
        self.axisFK = AxisLayerFK(side=side_flag, mano_assets_root="/home/ubuntu/hand/manotorch/assets/mano").to('cuda')
        self.mano_layer = ManoLayer(rot_mode="axisang",
                                    side=side_flag,
                               center_idx=9,
                               mano_assets_root="/home/ubuntu/hand/manotorch/assets/mano",
                               use_pca=False,
                               flat_hand_mean=True).to('cuda')
        # self.axisFK = AxisLayerFK(mano_assets_root="/local/home/huizhang/intern/manotorch/assets/mano").to('cuda')
        # self.mano_layer = ManoLayer(rot_mode="axisang",
        #                        center_idx=9,
        #                        mano_assets_root="/local/home/huizhang/intern/manotorch/assets/mano",
        #                        use_pca=False,
        #                        flat_hand_mean=True).to('cuda')
