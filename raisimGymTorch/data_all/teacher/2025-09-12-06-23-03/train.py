...
if args.load_trained_policy:
    load_param(saver.data_dir.split('eval')[0] + weight_path, env, actor_r, critic_r, critic_cost_r, p3o_r.optimizer, saver.data_dir, cfg_grasp)
